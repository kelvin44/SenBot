...
//
const           BotName           =           'Black Bot'; // Nama Bot Whatsapp
const    instagramlu    =    'https://instagram.com/ff.kelvin15?igshid=1s2yxrje0vzp8' ; // Nama Instagramlu cok
const  whatsapplu  =  '' 085212830930''; // Nomor whatsapplu cok
const kapanbotaktif = '14 Jam'; // Kapan bot lu aktif
const grupch1 = 'gak punya'; // OFFICIAL GRUP LU 1
const grupch2 = 'gak punya'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
